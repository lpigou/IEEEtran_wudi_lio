...
Future works include learning the share representation amongst the heterogeneous inputs in a more meaningful fashion as in~\cite{neverova2014moddrop} and integrate the overall system into a unified deep learning framework by replacing the temporal modelling part with Recurrent Neural Nets such as the work of ~\cite{graves2009novel}.
