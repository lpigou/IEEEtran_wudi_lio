...
%
In most cases, Restriced Boltzmann machine (RBM) are considered as a network of symmetrically coupled stochastic binary units
(called the visible and hidden units). 
%
