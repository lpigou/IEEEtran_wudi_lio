...
For speech recognition community~\cite{yu2012automatic}, a common approach is to adopt the trained GMM-HMM to have the alignment labels and use them for the DNNs. Although we could potentially adopt the same route, the contribution to the quality of the labels may be trivial considering the increase of the training time. Hence, we argue that the forced alignment scheme will suffice.
