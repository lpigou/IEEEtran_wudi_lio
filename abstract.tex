...
The performance is on par with a variety of state-of-the-art hand-tuned feature-based approaches and other learning-based methods, therefore opening the door on using deep learning techniques to further explore multimodal time series data.
\end{abstract}
