...
%
More precisely, a semi-supervised hierarchical dynamic framework relying a Hidden Markov Model (HMM) 
is proposed for simultaneous gesture segmentation and recognition taking skeleton joints, 
depth and RGB images as input observations.
%
...
opening the door for using deep learning techniques to further explore multimodal time series.
\end{abstract}
