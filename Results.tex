...
However, the modalities by themselves have more difficulties to improve the recognition due to performer variations, 
in particular differentiating  people that gesticulate more (see Fig.~\ref{fig:bodydynamics}).
