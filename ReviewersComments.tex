...
%
In addition, further experiments wit an intermediate fusion scheme learning a joint multimodal representation have been conducted.
%
...
\item finally, an intermediate fusion scheme that learns a shared representation has also been implemented and evaluated. Its description is provided in Section IV.D.
...
\noindent However, as their method is very similar to the intermediate fusion scheme we have now implemented, we have added the following in Section IV.D.2:
