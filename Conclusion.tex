...
%
In this paper, we presented a novel Deep Dynamic Neural Network (DDNN) for continuous gesture recognition on multimodal data comprising image and depth (RGB-D) data and skeleton features. % I chose this formulation because of the similarity to continuous speech recognition.
